...
type DispatcherGlobal = typeof globalThis & {
  __raincodeWebHttpDispatcherConfigured?: boolean;
};
...
export function configureHttpDispatcher(
  ...
  if (dispatcherGlobal.__raincodeWebHttpDispatcherConfigured) return;
  ...
  dispatcherGlobal.__raincodeWebHttpDispatcherConfigured = true;
}
