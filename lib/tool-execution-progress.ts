/**
 * Extracts a single displayable progress line from a tool's partialResult
 * (last non-empty text line, whitespace-collapsed, tail-bounded). Sole owner
 * of tool execution progress text extraction.
 */
