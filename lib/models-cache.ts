...
declare global {
  var __raincodeModelsCacheState: ModelsCacheState | undefined;
}
...
function getModelsCacheState(): ModelsCacheState {
  if (!globalThis.__raincodeModelsCacheState) {
    globalThis.__raincodeModelsCacheState = {
      entries: new Map(),
      inFlight: new Map(),
      generation: 0,
    };
  }
  return globalThis.__raincodeModelsCacheState;
}
