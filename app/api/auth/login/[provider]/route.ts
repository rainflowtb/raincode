...
declare global {
  var __raincodeLoginCallbacks: Map<string, { resolve: (v: string) => void; reject: (e: Error) => void }> | undefined;
}

function getCallbackRegistry() {
  if (!globalThis.__raincodeLoginCallbacks) globalThis.__raincodeLoginCallbacks = new Map();
  return globalThis.__raincodeLoginCallbacks;
}
